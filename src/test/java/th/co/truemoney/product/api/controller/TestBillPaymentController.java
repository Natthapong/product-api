...
public class TestBillPaymentController extends BaseTestController {
	...
	public void urlCreateBillInvoice() throws Exception {
		Bill billInvoice = new Bill("123",Status.CREATED, createStubbedBillPaymentInfo());
		billInvoice.setID("9999");
		when(
				this.billPaymentServiceMock.createBill(
						any(BillInfo.class), anyString())).thenReturn(
								billInvoice);
