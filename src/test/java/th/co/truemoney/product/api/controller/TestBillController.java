...
public class TestBillController extends BaseTestController {
	...
	public void urlCreateBillInvoice() throws Exception{
		when(this.billPaymentServiceMock.createBillInvoice(any(BillPaymentInfo.class),anyString())).thenReturn(new BillInvoice());
		this.verifySuccess(this.doPOST(verifyTransferURL, new BillPaymentInfo()));
	}
