...
public class TestBillPayActivityDetailViewHandler {
	...
	public static Iterable<BillTest[]> data() {
		BillTest[][] data = new BillTest[][] {
				...
				{ new BillTest("bla", "bla", "กรุงเทพประกันชีวิต", "12345", "Ref. No.1", "เลขที่สัญญา", "54321", "Ref. No.2", "เลขที่อ้างอิง") },
				...
				{ new BillTest("gepc", "gepc", "สินเชื่อบุคคล อยุธยา แคปปิตอล เซอร์วิสเซส", "12345", "", "หมายเลขบัญชี") },
				{ new BillTest("qc", "qc", "สินเชื่อเงินสดควิกแคช", "12345", "REF1", "หมายเลขสมาชิก") },
				{ new BillTest("tescopl", "tescopl", "สินเชื่อเทสโก้ โลตัส", "12345", "Account Number", "หมายเลขบัตร") },
				{ new BillTest("tesco", "tesco", "บัตรเครดิตเทสโก้ โลตัส", "12345", "Account Number", "หมายเลขบัตร") },
				{ new BillTest("centralpl", "centralpl", "เซ็นทรัล เอ็กซ์คลูซีฟ แคช", "12345", "Account Number", "หมายเลขสมาชิก") },
				{ new BillTest("central", "central", "เซ็นทรัล เครดิตคาร์ด", "12345", "", "หมายเลขบัตรเครดิต") }, 
				{ new BillTest("robinson", "robinson", "ซิมเพิล วีซ่า คาร์ด", "12345", "Account Number", "หมายเลขบัตรเครดิต") },
				...
				{ new BillTest("tli", "tli", "ไทยประกันชีวิต", "12345", "Ref. No. 1", "Ref. No. 1", "54321", "Ref. No. 2", "Ref. No. 2") },
				{ new BillTest("dlt", "dlt", "กรมการขนส่งทางบก", "12345", "", "เลขใบแจ้งชำระค่าภาษี", "54321", "", "หมายเลขอ้างอิง") },
				{ new BillTest("hp", "hp", "บัตรเครดิตโฮมโปร", "************1234", "Card Number", "หมายเลขบัตร") },
				{ new BillTest("central", "central", "เซ็นทรัล เครดิตคาร์ด", "************1234", "", "หมายเลขบัตรเครดิต") },
				...
				{ new BillTest("ktc", "ktc", "KTC", "************1234", "Account Number", "หมายเลขบัตร") }, 
				{ new BillTest("aeon", "aeon", "อิออน", "12345", "Ref. 1", "เลขที่อ้างอิง 1") },
				{ new BillTest("fc", "fc", "กรุงศรี เฟิร์สชอยส์", "************1234", "Account Number", "หมายเลขบัตร") },
				{ new BillTest("kcc", "kcc", "บัตรเครดิตกรุงศรี", "************1234", "Account Number", "หมายเลขบัตรเครดิต") },
				{ new BillTest("pb", "pb", "เพาเวอร์บาย คาร์ด", "************1234", "Account Number", "หมายเลขบัตร") },
